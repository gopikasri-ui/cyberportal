import { c as createLucideIcon, a as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, o, i as invariant, u as useIncidentStore, j as jsxRuntimeExports } from "./index-ljKLTZYa.js";
import { C as Clock, a as CircleCheck, B as Badge } from "./badge-D910ikyI.js";
import { c as clsx, B as Button } from "./button-96lfI4Wz.js";
import { S as Skeleton, R as RefreshCw } from "./skeleton-D4tHT_Di.js";
...
function getDayLabel(daysAgo) {
  const d2 = new Date(Date.now() - daysAgo * 864e5);
  return d2.toLocaleDateString("en-US", { weekday: "short" });
}
function buildTypeData(incidents) {
  const map2 = {
    malware: 0,
    phishing: 0,
    breach: 0,
  ...
  for (const inc of incidents) {
    if (inc.type_ in map2) map2[inc.type_]++;
  }
  return Object.entries(map2).filter(([, v2]) => v2 > 0).map(([name, value]) => ({
...
function buildTimelineData(incidents) {
  return Array.from({ length: 7 }, (_, i) => {
    ...
    const count = incidents.filter((inc) => {
      const t2 = Number(inc.timestamp);
      return t2 >= dayStart.getTime() && t2 < dayEnd.getTime();
    }).length;
    return { day: getDayLabel(daysAgo), count };
  });
}
function buildSeverityData(incidents) {
  const keys2 = ["low", "medium", "high", "critical"];
  return keys2.map((sev) => ({
...
function MetricCard({
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glassmorphic-card rounded-xl p-5 flex flex-col gap-3", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold font-display", style: { color: accent }, children: value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cyber-secondary font-body leading-snug", children: label })
      ]
    }
  );
}
function CyberTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glassmorphic-card rounded-lg px-3 py-2 text-xs", children: [
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cyber-secondary mb-1", children: label }),
    payload.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: p2.color ?? "#6b8cff" }, children: [
      p2.name ? `${p2.name}: ` : "",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: p2.value })
    ] }, p2.name ?? p2.value))
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-xs font-mono text-cyber-blue", children: alert.id }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-xs text-cyber-secondary", children: alert.source }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "badge-critical pulse-critical inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-current" }),
            "CRITICAL"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-xs text-cyber-secondary whitespace-nowrap", children: formatTime(alert.timestamp) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge-high rounded-full px-2 py-0.5 text-xs font-medium", children: alert.acknowledged ? "ACK" : "OPEN" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onKeyDown: (e3) => {
                if (e3.key === "Enter" || e3.key === " ") setExpanded((v2) => !v2);
              },
    ...
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b border-cyber-border/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-cyber-blue mb-1", children: alert.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: alert.description }),
          alert.incidentId && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-cyber-blue", children: [
            "Linked incident:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: alert.incidentId })
          ] })
        ]
      }
    ) }) })
...
function OfflineSyncCard() {
  ...
  const [lastSynced, setLastSynced] = reactExports.useState(7);
  const handleSync = () => {
    setSyncing(true);
    setTimeout(() => {
      setSyncing(false);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "w-4 h-4", style: { color: "#ffb347" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "Offline Queue" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "outline",
                  className: "badge-high rounded-full px-2 py-0.5 text-xs font-bold border-0",
                  children: "3 pending sync"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-cyber-secondary", children: [
              "Last synced:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cyber-blue", children: lastSynced === 0 ? "just now" : `${lastSynced} minutes ago` })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function Dashboard() {
  ...
  const criticalAlerts = reactExports.useMemo(
    () => alerts.filter((a2) => a2.severity === "critical" && !a2.acknowledged).slice(0, 3),
    [alerts]
  );
  const typeData = reactExports.useMemo(() => buildTypeData(incidents), [incidents]);
  const timelineData = reactExports.useMemo(() => buildTimelineData(incidents), [incidents]);
  const severityData = reactExports.useMemo(() => buildSeverityData(incidents), [incidents]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 p-4 sm:p-6 cyber-grid min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-xl font-bold font-display text-foreground flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-5 h-5 text-cyber-blue" }),
          "SOC Dashboard"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cyber-secondary mt-0.5", children: "Real-time incident operations overview" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-cyber-green pulse-dot" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-cyber-secondary hidden sm:inline", children: "Live" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              loading,
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "w-4 h-4" }),
              value: 3,
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-sm font-semibold text-foreground mb-4 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-4 rounded-full bg-cyber-blue" }),
              "Incident Types"
            ] }),
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Skeleton,
              {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Pie,
                  {
                    ...
                    outerRadius: 72,
                    paddingAngle: 3,
                    children: typeData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Cell,
                      {
                        fill: entry.color,
                        stroke: "transparent"
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(CyberTooltip, {}) })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-x-3 gap-y-1.5", children: typeData.map((d2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    d2.name,
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", style: { color: d2.color }, children: d2.value })
                  ]
                },
                d2.name
              )) })
              ...
              BarChart,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Tooltip,
                    {
                      content: /* @__PURE__ */ jsxRuntimeExports.jsx(CyberTooltip, {}),
            ...
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              BarChart,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", name: "Count", radius: [3, 3, 0, 0], children: severityData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, entry.name)) })
                ]
              }
            ) })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-b border-cyber-border/30 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-4 h-4", style: { color: "#ff4757" } }),
              "Critical Alerts",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge-critical pulse-critical rounded-full px-2 py-0.5 text-xs font-bold", children: criticalAlerts.length })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-cyber-secondary hidden sm:inline", children: "Click row to expand details" })
          ] }),
          loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 space-y-3", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Skeleton,
            {
            ...
            i
          )) }) : criticalAlerts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-10 flex flex-col items-center gap-2 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-8 h-8", style: { color: "#2de3a5" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-cyber-secondary", children: "No critical alerts" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cyber-secondary opacity-60", children: "All critical alerts have been acknowledged" })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left min-w-[540px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b border-cyber-border/20", children: ["Alert ID", "Source", "Severity", "Time", "Status", ""].map(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: criticalAlerts.map((alert) => /* @__PURE__ */ jsxRuntimeExports.jsx(AlertRow, { alert }, alert.id)) })
          ] }) })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OfflineSyncCard, {})
  ] });
}
export {
